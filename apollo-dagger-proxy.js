...
const DAGGER_PORT = 9998;  // Dagger listen port
const PROXY_PORT = 9999;
const SESSION_TOKEN = '8d3c9afd-1049-40b9-b7e0-48965db3c2a5';
      ...
      proxyRes.on('end', () => {
        ...
        if (responseBody.includes('unauthorized') || responseBody.includes('401') || responseBody === '') {
          ...
          const authOptions = {
            ...
            headers: {
              ...options.headers,
              'Authorization': 'Basic ' + Buffer.from(SESSION_TOKEN + ':').toString('base64')
            }
          };
